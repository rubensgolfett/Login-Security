            ...
            <div id="forms">
                ...
                <form action="<?= $_SERVER['PHP_SELF']?>" method="post" autocomplete="on">
                    ...
                    <div class="camp">
                        ...
                        <input type="email" name="create-email" id="ilogin" placeholder="Enter your E-mail" required autocomplete="email" maxlength="50" class="btn">
                    </div>
                    ...
                    <p>You have an account? <a href="login.php" id="min-bottom">Login here!</a></p>
